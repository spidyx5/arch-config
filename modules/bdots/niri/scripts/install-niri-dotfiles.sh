#!/usr/bin/env bash
# Post-install hook for bdots-niri module
...
echo -e "${BLUE}Configuring Niri environment...${NC}"
echo ""
...
echo -e "${GREEN}Niri environment configuration complete!${NC}"
echo ""
echo -e "${BLUE}Dotfiles are symlinked from arch-config/modules/bdots-niri/dotfiles/${NC}"
echo ""
